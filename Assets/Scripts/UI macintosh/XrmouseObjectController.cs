...
public class XrmouseObjectController : MonoBehaviour
{
    [SerializeField] GameObject mouseObject;
    [SerializeField] GameObject screenObject;
    [SerializeField] MacUIController UI;
    ...
    private void MoveCheck(){
        ...
        if(Input.GetKeyDown(KeyCode.UpArrow)) fakepos.y += mouseSpeed;
        if(Input.GetKeyDown(KeyCode.DownArrow)) fakepos.y -= mouseSpeed;
        if(Input.GetKeyDown(KeyCode.LeftArrow)) fakepos.x -= mouseSpeed;
        if(Input.GetKeyDown(KeyCode.RightArrow)) fakepos.x += mouseSpeed;
    ...
    private void ClickCheck(){
        if (previousTargetElement != null && Input.GetKeyDown(KeyCode.C)){
